...
![Class Diagram](https://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/AlessandroBernardoEusebio/cpp-oop-review/refs/heads/main/docs/class-diagram.puml)
## Prerequisites
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/AlessandroBernardoEusebio/cpp-oop-review.git
   cd cpp-oop-review
   ```
